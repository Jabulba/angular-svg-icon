...
const DEPLOY_URL = new InjectionToken('DEPLOY_URL');
...
function SVG_ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry, loader, platformId, deployUrl, serverUrl, document) {
...
export { AngularSvgIconModule, DEPLOY_URL, SERVER_URL, SVG_ICON_REGISTRY_PROVIDER, SVG_ICON_REGISTRY_PROVIDER_FACTORY, SvgHttpLoader, SvgIconComponent, SvgIconRegistryService, SvgLoader };
