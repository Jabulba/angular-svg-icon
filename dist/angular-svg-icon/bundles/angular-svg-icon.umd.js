(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DEPLOY_URL = new core.InjectionToken('DEPLOY_URL');
    var SERVER_URL = new core.InjectionToken('SERVER_URL');
    var SvgIconRegistryService = /** @class */ (function () {
        function SvgIconRegistryService(loader, platformId, deployUrl, serverUrl, _document) {
            this.loader = loader;
    ...
    SvgIconRegistryService.ctorParameters = function () { return [
        ...
        { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: [DEPLOY_URL,] }] },
